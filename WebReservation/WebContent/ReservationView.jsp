      ...
      <td width="25%" valign="top">
		...
		<tr>
			<td>
				...
				<input id="demo3" type="text" size="20" title="tooltip for you">
...
- See more at: http://www.w3resource.com/javascript/form/javascript-sample-registration-form-validation.php#sthash.hf3KIOYG.dpuf
